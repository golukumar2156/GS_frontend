  ...
  const testimonials = [
    {
      ...
      content: 'Implementing this OrderCapture system has transformed our business operations. The inventory management features alone have saved us countless hours and reduced errors by 35%.',
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Don't just take our word for it. See what our customers have to say about how our OrderCapture system has transformed their businesses.
          </p>
        </div>
