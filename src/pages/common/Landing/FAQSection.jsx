...
const FAQSection = () => {
  const faqs = [
    {
      question: "Can I use the OrderCapture system offline?",
      answer: "Yes! Our OrderCapture system works completely offline. All data syncs automatically when you're back online, ensuring uninterrupted business operations even during internet outages."
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Everything you need to know about our OrderCapture system. Can't find the answer you're looking for? 
