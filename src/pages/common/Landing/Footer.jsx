        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <div className="h-8 w-40 rounded-md bg-primary flex items-center justify-center mr-2">
                <span className="text-primary-foreground font-bold text-lg">OrderCapture</span>
              </div>
              <span className="text-foreground font-bold text-xl">OrderCapture</span>
            </div>
            <p className="mb-4 text-muted-foreground max-w-md">
              Empowering retailers with smart OrderCapture solutions that streamline operations, 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-sm text-muted-foreground">
              <p>&copy; {currentYear} OrderCapture. All rights reserved.</p>
            </div>
